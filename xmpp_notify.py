...
class JanitorNotifier(slixmpp.ClientXMPP):
    ...
    async def on_start(self, event):
        ...
        self.plugin['xep_0045'].join_muc(
            self.channel, self.nick, wait=True)
        ...
        if message == 'scan':
            ...
            async with ClientSession() as session, \
                ...
                if resp.status in (200, 202):
                    ...
                    await reply('Merge proposal scan failed: %d.'
                                % resp.status)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--jid', help='Jabber ID', default='janitor@jelmer.uk')
    parser.add_argument(
        '--password', help='Password', default=None)
    parser.add_argument(
    ...
    parser.add_argument(
        '--channel', type=str, help='Channel', default=None)
    parser.add_argument(
