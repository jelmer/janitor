...
The Debian Janitor regularly runs `lintian-brush
<https://salsa.debian.org/jelmer/lintian-brush>`_ over all packages in the
archive that maintained in Git.

The resulting changes can be accessed on this site, or the Janitor can
