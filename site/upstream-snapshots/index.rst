...
To use the apt repository, run something like::
   ...
   echo deb https://janitor.debian.net/ upstream-snapshots/ > /etc/apt/sources.list.d/janitor.list
...
To e.g. install the version of *cifs-utils* that's in this repository, run::
   ...
   apt install -t upstream-snapshots cifs-utils
...
`the documentation about apt preferences <https://wiki.debian.org/AptPreferences>`_)::
    ...
    Package: cifs-utils
    Pin: release a=upstream-snapshots
    Pin-Priority: 800
