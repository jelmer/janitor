...
fn test_source_file_roundtrip() {
    ...
    // Add some files
    src1.files.push(crate::sources::SourceFileEntry::new(
        "abc123",
        1024,
        "test_1.0.0.dsc",
    ));
    ...
    src1.checksums_sha256
        .push(crate::sources::SourceFileEntry::new(
            "fedcba654321",
            1024,
            "test_1.0.0.dsc",
        ));
