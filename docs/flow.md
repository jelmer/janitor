...
simple, in which case they just output a candidate for each package in a campaign
 ...
 * previous success rate (for the campaign/package combination and the package itself)
