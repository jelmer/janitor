...
simple, in which case they just output a candidate for each codebase in a suite
 ...
 * previous success rate (for the suite/codebase combination and the codebase itself)
